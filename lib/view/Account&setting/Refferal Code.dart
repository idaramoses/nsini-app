                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text("Helena journeys",style:TextStyle(color:notifier.textColor,fontSize: 17,),),
                                                    ),
                                                    AppConstants.Height(10),
                                                    Padding(
                                                    ...
                                                    // Padding(
                                                    //   padding: const EdgeInsets.only(left: 15,right: 15),
                                                    //   child: Text("I earnied 5 in assets by finishing 1 lesson about 4 investments",style:TextStyle(color:notifier.textColor,fontSize: 23,),),
                                                    // ),
                                                    const Spacer(),
                                                    Container(
                                                      height: 110,
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          const Center(child: Text("Use referral code and earn commission",style: TextStyle(color: Color(0xffB59CFA),fontSize: 13,),),),
                                                          AppConstants.Height(17),
                                                          Container(
                                                            height: 45,
