                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          const Text("BANK OF AMERICA",style: TextStyle(color: Colors.white,fontSize: 16,),),
                      ...
                      Row(
                        children: [
                          const Text("**** **** **** 7777",style: TextStyle(fontSize: 14,color: Colors.white,),),
                          const Spacer(),
                      ...
                      const Row(
                        children: [
                          Text("Helena Sarapova",style: TextStyle(fontSize: 14,color: Color(0xffFFFFFF),),),
                          Spacer(),
                          Text("12/2023",style: TextStyle(fontSize: 14,color: Color(0xffFFFFFF),),),
                        ],
                      ),
                    ],
                  ),
