...
class Diphthongs extends StatefulWidget {
  const Diphthongs({super.key});

  @override
  State<Diphthongs> createState() => _DiphthongsState();
}

class _DiphthongsState extends State<Diphthongs> {
  ...
  Future<List<Map<String, dynamic>>> _fetchData() async {
    try {
      return await getCachedData('Diphthongs');
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: FutureBuilder(
          future: Hive.openBox('diphthongs'),
                    ...
                    Card(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          title: Text(
                            '${typedData[index]['Diphthong'] ?? ''}${typedData[index]['Sound'] ?? ''}',
                            style: GoogleFonts.notoSans(
                              color: Themes.getTextColor(context),
                              fontSize: 13.sp,
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Center(
                        child: Text(
                          '${widget.data[index]['Diphthong'] ?? ''}${widget.data[index]['Sound'] ?? ''}',
                          style: GoogleFonts.notoSans(
                            fontSize: 24.0,
