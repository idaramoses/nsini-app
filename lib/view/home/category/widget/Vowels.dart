...
class _VowelsState extends State<Vowels> {
  ...
  Future<List<Map<String, dynamic>>> _fetchData() async {
    try {
      return await getCachedData('Vowels');
    } catch (e) {
                    ...
                    Card(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          title: Text(
                            '${typedData[index]['Vowels'] ?? ''}${typedData[index]['Sound'] ?? ''}',
                            style: GoogleFonts.notoSans(
                              color: Themes.getTextColor(context),
                              fontSize: 13.sp,
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Center(
                        child: Text(
                          '${widget.data[index]['Vowels'] ?? ''}${widget.data[index]['Sound'] ?? ''}',
                          style: GoogleFonts.notoSans(
                            fontSize: 24.0,
